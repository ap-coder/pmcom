        ...
        <div class="section-inner">
            <div class="section-title">
                ...
                <ul class="post-meta">
                    ...
                    @if(has_option('blog', 'post_meta_cate'))<li itemprop="about"><a href="{{url('blog/category/'.$term_slug)}}" itemprop="url"><i class="pe-7s-notebook"></i> {{get_term_name($single->term_id)}}</a></li>@endif
