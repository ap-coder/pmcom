<div class="portfolio-item fadeIn filter-cat{{$item->term_id}}">
    <div class="portfolio-wrap">
        <img itemprop="image" src="{{get_attachment_url($item->thumbnail, has_option('portfolio', 'imagesize', 'full'))}}" class="img-fluid" alt="{{$item->post_title}}">
        ...
        <div class="portfolio-info">
            <h6 itemprop="text"><a href="{{url('portfolio/'.$item->post_name)}}" itemprop="url">{{$item->post_title}}</a></h6>
            <div>
                @if($item->portfolio_type == 'iframe')
